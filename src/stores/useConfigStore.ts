...
const extractSectionValue = (config: Config | null, section?: RawConfigSection) => {
  ...
  switch (section) {
    ...
    case 'request-log-success-body':
      return config.requestLogSuccessBody;
    case 'detailed-api-error-body-log-limit':
      return config.detailedAPIErrorBodyLogLimit;
    ...
    case 'routing/token-threshold-rules':
    ...
    set((state) => {
      ...
      switch (section) {
        ...
        case 'request-log':
          ...
          break;
        case 'request-log-success-body':
          nextConfig.requestLogSuccessBody = value as Config['requestLogSuccessBody'];
          break;
        case 'detailed-api-error-body-log-limit':
          nextConfig.detailedAPIErrorBodyLogLimit = value as Config['detailedAPIErrorBodyLogLimit'];
          break;
        case 'logging-to-file':
        ...
        case 'routing/strategy':
          ...
          break;
        case 'routing/token-threshold-rules':
          nextConfig.tokenThresholdRules = value as Config['tokenThresholdRules'];
          break;
        case 'api-keys':
        ...
        case 'codex-api-key':
          ...
          break;
        case 'ollama-api-key':
          nextConfig.ollamaApiKeys = value as Config['ollamaApiKeys'];
          break;
        case 'claude-api-key':
