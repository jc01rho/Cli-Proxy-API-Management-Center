...
export const CONFIG_TAB_ICONS: Record<ConfigTabId, ComponentType<IconProps>> = {
  ...
  advanced: IconShield,
  payload: IconCode,
  keeperExport: IconSlidersHorizontal,
};
...
export const FIELD_VALUE_KEYS: Record<string, readonly string[]> = {
  ...
  port: ['port'],
  authDir: ['authDir'],
  apiKeys: ['apiKeysText', 'apiKeyModelWhitelists'],
  apiKeyIpBlacklist: [
  ...
  keeperExportEnabled: ['keeperExport'],
  keeperDelivery: ['keeperExport'],
  keeperMetadata: ['keeperExport'],
  keeperPrivacy: ['keeperExport'],
  keeperTokenEnv: ['keeperExport'],
