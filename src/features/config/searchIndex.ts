...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    yamlKeys: ['api-keys', 'api-key-model-whitelists'],
    keywords: ['api key', 'apikey', 'token'],
  },
  {
    fieldId: 'apiKeyIpBlacklist',
    sectionId: 'advanced',
    labelKey: L('sections.auth.ip_blacklist_blocked_title'),
    yamlKeys: ['api-key-ip-blacklist'],
  },
  {
    fieldId: 'tlsEnable',
    sectionId: 'connectivity',
  ...
  },
  {
    fieldId: 'routingMode',
    sectionId: 'advanced',
    labelKey: L('sections.network.routing_mode'),
    hintKey: L('sections.network.routing_mode_hint'),
    yamlKeys: ['routing', 'mode'],
  },
  {
    fieldId: 'tokenThresholdRules',
    sectionId: 'advanced',
    labelKey: L('sections.network.token_threshold_rules_title'),
    hintKey: L('sections.network.token_threshold_rules_desc'),
    yamlKeys: ['routing', 'token-threshold-rules'],
  },
  {
    fieldId: 'fallbackModels',
    sectionId: 'advanced',
    labelKey: L('sections.fallback.models_title'),
    yamlKeys: ['fallback', 'models'],
  },
  {
    fieldId: 'fallbackChain',
    sectionId: 'advanced',
    labelKey: L('sections.fallback.chain_title'),
    yamlKeys: ['fallback', 'chain'],
  },
  {
    fieldId: 'fallbackMaxDepth',
    sectionId: 'advanced',
    labelKey: L('sections.fallback.max_depth_title'),
    yamlKeys: ['fallback', 'max-depth'],
  },
  {
    fieldId: 'oauthEndpointOverrides',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.title'),
