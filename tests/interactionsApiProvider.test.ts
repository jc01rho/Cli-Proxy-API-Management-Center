...
describe('Interactions API key provider', () => {
  ...
  test('saves the whole interactions list while preserving unknown fields', async () => {
    let putData: unknown;
    apiClient.get = (async () => ({
      'interactions-api-key': [
        {
  ...
  test('saves and deletes keys through the interactions management endpoints', async () => {
